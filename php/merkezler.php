...
<html>
  <head>
    ...
    <link href="../css/merkezler.css" rel="stylesheet" />
    <script>
      setTimeout(function() {
  ...
  <body>
        ...
        <div class="links-side-content">
          ...
          <div class="links">
            ...
            <ul>
              ...
              <li>
                <a href="merkezler.php" class="active">
    ...
    <div class="container">
      <h1 class="merrkezlerimiz-h1">Merkezlerimiz</h1>
      <div class="merkez-tipleri">
        <div class="merkez subeler" id="subeler">
          <h1>Şubeler</h1>
          <div class="info"></div>
          <button class="setBtn">Şehirleri Seç</button>
        </div>
        <div class="merkez temsilcilikler" id="temsilcilikler">
          <h1>Temsilcilikler</h1>
          <div class="info"></div>
          <button class="setBtn">Şehirleri Seç</button>
        </div>
        <div class="merkez grublar" id="grublar">
          <h1>Çalışama Grupları</h1>
          <div class="info"></div>
          <button class="setBtn">Şehirleri Seç</button>
        </div>
      </div>
    ...
    <script src="../js/merkezler.js"></script>
